...
SELECT     dbo.OrdenesPago.Id, dbo.OrdenesPago.SucursalId, dbo.OrdenesPago.Fecha, dbo.OrdenesPago.LCN, dbo.OrdenesPago.TipoGastoId, 
                      ...
                      dbo.Operadores.Usuario AS Operador, dbo.Proveedores.Cuit
FROM         dbo.OrdenesPago LEFT OUTER JOIN
                      dbo.Operadores ON dbo.OrdenesPago.OperadorModificacionId = dbo.Operadores.Id LEFT OUTER JOIN
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vOrdenesPago2';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vOrdenesPago2';
