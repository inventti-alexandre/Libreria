CREATE VIEW dbo.[vInformeStockMinimo]
AS
SELECT     dbo.Titulos.Cod, dbo.TitulosStock.StkPr, dbo.TitulosStock.StkCn, dbo.Titulos.PrecioVentaTitulo AS PrcVta1, dbo.Proveedores.Denominacion, 
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vInformeStockMinimo';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'3885
         Alias = 900
         Table = 1170
         Output = 720
         Append = 1400
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vInformeStockMinimo';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vInformeStockMinimo';
