...
create PROCEDURE [dbo].[usp_SeleccionarTituloSelArt4]
	@Todo as nvarchar(1),
	@Proveedor int,
...
SELECT Titulos.Cod AS Cod, Titulos.NombreTitulo AS Titulo, Autores.Nombre AS Autor, Proveedores.Cuenta AS nProv, 
        ...
        TitulosConsignaciones.CntVn AS CntVn
...
FROM  Titulos
    ...
    LEFT OUTER JOIN TitulosConsignaciones ON Titulos.Id = TitulosConsignaciones.TituloId 
