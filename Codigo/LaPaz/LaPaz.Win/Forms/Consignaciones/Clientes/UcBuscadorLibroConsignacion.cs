...
{
    public partial class UcBuscadorLibroConsignacion : UserControlBase
    {
        public UcBuscadorLibroConsignacion()
        {
        ...
        private void UcBuscadorLibroConsignacion_Load(object sender, EventArgs e)
        {
            //CargarCombos();
        }
