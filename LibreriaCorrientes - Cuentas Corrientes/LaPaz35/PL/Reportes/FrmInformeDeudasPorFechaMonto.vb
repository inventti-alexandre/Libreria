...
Public Class FrmInformeDeudasPorFechaMonto
    ...
    Private Sub PoblarReporte()
        ...
        '  Dim conne As New SqlConnection("Data Source=10.1.4.10\SQLEXPRESSPRAGMA;Initial Catalog=LCorrientes;user id=pragma;password=ap_sys_47")


        'Liberia
        Dim conne As New SqlConnection("Data Source=SERVERLCORRIENT;Initial Catalog=LCorrientes;user id=pragma;password=ap_sys")
