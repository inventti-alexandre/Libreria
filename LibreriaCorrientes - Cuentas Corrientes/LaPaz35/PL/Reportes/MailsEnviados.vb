...
Public Class MailsEnviados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CorrientesCtaCte.MailsEnviados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMailsEnviados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MailsEnviados = New MailsEnviados()
        rpt.Site = Me.Site
        Return rpt
    End Function
