...
Partial Public Class TiposGastos
    Public Property Id As Integer
    Public Property Nombre As String
    Public Property Abreviatura As String
    Public Property Descripcion As String
    Public Property BienDeUso As Nullable(Of Boolean)
    ...
    Public Overridable Property OrdenesPago As ICollection(Of OrdenesPago) = New HashSet(Of OrdenesPago)
